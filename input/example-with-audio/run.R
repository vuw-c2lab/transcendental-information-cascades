...
setwd("~/OneDrive - Victoria University of Wellington - STAFF/Git/transcendental-information-cascades/input/example-with-audio/")
...
# data source
dataSource <- "example.wav"

# select tokeniser
tokeniser <- "discrete/signal-WAV-spectral"
...
# select tokeniser
tokeniser <- "discrete/signal-WAV-speech-to-text"
